...
## 2026-09-16
* **Update**: PR #3 적대적 리뷰에서 나온 권한 결함 3건(메뉴 제한을 좁혀도 살아남던 기존 역할 권한, `SYS_MENUS` 조회를 꺼서 만드는 메뉴 관리 자물쇠, Next 기본 1MB에 걸려 실패하던 프로필 사진 업로드) 수정에 맞춰 [BO 인증·권한](/architecture/bo-auth.md)의 모델·토큰·메뉴 쓰기 규칙·프론트 연동 절, [hoka-bo-api](/projects/hoka-bo-api.md)·[hoka-bo-front](/projects/hoka-bo-front.md)의 Stack·Notes 갱신.
