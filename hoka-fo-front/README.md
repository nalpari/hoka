...
- 프로젝트 설명: [`okf/projects/hoka-fo-front.md`](../okf/projects/hoka-fo-front.md)
...
모든 명령은 `hoka-fo-front/` 디렉터리에서 실행합니다.
...
기본 포트는 `3000`입니다. hoka-bo-front도 기본 포트가 `3000`이라 둘을 함께 띄우면 충돌합니다. 이때는 hoka-bo-front를 `3001`로 띄웁니다([hoka-bo-front README](../hoka-bo-front/README.md#실행)).
...
백엔드는 [hoka-fo-api](../hoka-fo-api/README.md)를 쓸 예정이며, 아직 API를 호출하는 코드는 없습니다.
